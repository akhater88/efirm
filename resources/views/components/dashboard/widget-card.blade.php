...
">
    ...
    ">
        <div style="display: flex; align-items: center; gap: 8px;">
            @if ($icon)
                <span style="color: var(--text-tertiary, #7A5050); display: flex; align-items: center;">
                    {{ $icon }}
                </span>
            @endif
    ...
    <div style="flex: 1; padding: 0;">
        ...
        @elseif ($state === 'empty')
            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 48px 16px; text-align: center;">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="var(--text-tertiary, #7A5050)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="margin-bottom: 8px; opacity: 0.5;"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18"/></svg>
