<section id="security" aria-labelledby="security-heading" class="py-12 md:py-16 lg:py-24 px-6 lg:px-8">
    <div class="max-w-5xl mx-auto">
        {{-- Header --}}
        <div class="text-center mb-12 lg:mb-16">
            <p class="text-sm font-semibold text-brand-500 uppercase tracking-wider mb-4">
                {{ __('marketing.security.eyebrow') }}
            </p>
            <h2 id="security-heading" class="text-2xl md:text-3xl lg:text-4xl font-bold text-neutral-900 mb-4">
                {{ __('marketing.security.headline') }}
            </h2>
            <p class="text-lg text-neutral-600 max-w-3xl mx-auto">
                {{ __('marketing.security.body') }}
            </p>
        </div>

        {{-- 6-cell grid --}}
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach (__('marketing.security.cells') as $cell)
