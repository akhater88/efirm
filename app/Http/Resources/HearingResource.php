...
class HearingResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'postponement_reason_ar' => $this->postponement_reason_ar,
            'postponement_reason_en' => $this->postponement_reason_en,
            'postponement_initiated_by' => $this->postponement_initiated_by,
            'is_postponement' => $this->is_postponement,
