...
class MatterResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'target_closing_date' => $this->target_closing_date?->toDateString(),
            'deal_value_currency' => $this->deal_value_currency,
            'deal_value_amount' => $this->deal_value_amount,
            'expected_document_types' => $this->expected_document_types,
